...
Output: "GeeksforGeeks"Explanation: Name "GeeksforGeeks" has maximum length among all names.
```

```
Input: arr[] = ["Apple", "Mango", "Orange", "Banana"]Output: "Orange"Explanation: Names "Orange" and "Banana" both have maximum length among all names but Orange comes first so answer will be "Orange".
```
